...
class billiard_ellipse:
    ...
    def motion_calculate(self):
        ...
        for i in range(1,self.N):
            ...
            if (self.x[i]**2/1000+self.y[i]**2/1000> 0.001):
    ...
    def plot_boundary(self):
        ...
        while theta < 2*np.pi:
            ...
            theta+= 0.01
        plt.title(r'Elliptical stadium  $\frac{x^2}{1001}+\frac{y^2}{1000} = 0.001$')
...
A=billiard_ellipse(1,0,1,0.1,21000,0.01)
A.motion_calculate()
A.plot1()
B=billiard_ellipse(1,0,1,0.1,21000,0.01)
B.motion_calculate()
B.plot2()