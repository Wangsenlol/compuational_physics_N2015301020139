...
class randomwalk():
    ...
    def coffee(self):
        while len(self.n_1) < self.num_points:
            num=uniform(0,1)
            if num < 0.5:
                x_1_step=uniform(0,2)
            else:
                x_1_step=uniform(-2,0)
        ...
        while len(self.n_2) < self.num_points:
            num=uniform(0,1)
            if num < 0.5:
                x_2_step=uniform(0,2)
            else:
                x_2_step=uniform(-2,0)
        ...
        while len(self.n_3) < self.num_points:
            num=uniform(0,1)
            if num < 0.5:
                x_3_step=uniform(0,2)
            else:
                x_3_step=uniform(-2,0)
        ...
        while len(self.n_4) < self.num_points:
            num=uniform(0,1)
            if num < 0.5:
                x_4_step=uniform(0,2)
            else:
                x_4_step=uniform(-2,0)
